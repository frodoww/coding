const CONFIG = {
    ...
    yesButton: "YES",
    noButton: "NO",
    noEscapeTexts: ["eits, gaaa bisaaa😝", "hehe, coba lagi yaaa 😜", "yaudaaa de,aku anggap YES yaaa! 💕"],
    ...
    flowerTitle: "ini kadooo spesial buat kamu my world. ",
